            ...
            <div className="container ft1-container pad-t-56 pad-x-80">
                <div className="ft1r1 mg-b-39">
                    <div className="ft1r1c1 footer__logo max-w285">
                        <img src={IMAGES.Logo} alt="DJOUBO Logo" className="mg-b-30"/>
                    ...
                    <div className="ft1r1c4 footer__social">
                        <div className="footer__appDownload mg-b-40">
                            ...
                            <div className="downloadLinks">
                                <a href="#"><img className="mg-r-16" src={IMAGES.AppStoreIcon} alt="App Store Icon" /></a>
                                <a href="#"><img src={IMAGES.GooglePlayIcon} alt="Google Play Icon" /></a>
                            </div>
                        </div>
                        <div className="footer__socialMedia">
                            <h3 className="font-20 lh-24 font-w600 font-fm-se mg-b-16">Retrouvez nous sur les réseaux sociaux</h3>
                            <div className="socialLinks">
                                <a href="#"><img className="mg-r-16" src={IMAGES.FacebookIcon} alt="Facebook Icon" /></a>
                                <a href="#"><img className="mg-r-16" src={IMAGES.InstagramIcon} alt="Instagram Icon" /></a>
                                <a href="#"><img className="mg-r-16" src={IMAGES.LinkedInIcon} alt="LinkedIn Icon" /></a>
                            </div>
                        </div>
                    </div>
                </div>
